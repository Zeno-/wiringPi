/*
 * mcp3208.c:
 *	Extend wiringPi with the MCP3208 SPI Analog to Digital convertor
...
/* Craig Robbins (Zeno-): Aug-2016, Modified 3004.c/.h to support MCP3208 */
...
/*
 * mcp3208Setup:
 *	Create a new wiringPi device node for an mcp3208 on the Pi's
 *	SPI interface.
 *********************************************************************************
 */
